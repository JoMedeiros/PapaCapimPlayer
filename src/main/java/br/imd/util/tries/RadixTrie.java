package br.imd.util.tries;

/**
 * @author Lucas Gomes Dantas
 * @date June the 18th, 2018
 * My implementation of a simple Radix Trie, developed while studying at UFRN, Brazil.
 */
...
public class RadixTrie
{
    ...
    /**
     * Instantiates a new Radix Trie with root being an empty string.
     */
